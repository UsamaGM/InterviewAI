  ...
  return (
    ...
    >
      <textarea
        ...
        onChange={onChange}
      />
      <span className="pointer-events-none absolute start-2.5 -translate-y-1/2 p-0.5 text-xs text-gray-700 transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-sm peer-focus:-top-[0.8rem] peer-focus:text-xs peer-focus:font-semibold duration-300 ease-in-out">
        {placeholder}
      </span>
    </label>
  );
