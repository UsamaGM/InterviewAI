...
const InterviewCard = ({
  ...
  return (
    <div className="relative w-[calc(50%-0.5rem)] bg-white/80 backdrop-blur-lg rounded-lg ring-2 ring-blue-200 hover:ring-blue-400 hover:scale-102 shadow-xl p-4 hover:shadow-none transition-all duration-300 flex flex-col gap-3">
